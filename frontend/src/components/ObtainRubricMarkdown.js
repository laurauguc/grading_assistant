...
function ObtainRubricMarkdown() {
  ...
  useEffect(() => {
    axios
      .get(BASE_URL.concat('api/convert-docx-to-md/'), { params: {docx_path: docx_path} }) // alternative: {params: {student_assignment: props.student_assignment, grading_rubric: props.grading_rubric}}
      .then(response => {
